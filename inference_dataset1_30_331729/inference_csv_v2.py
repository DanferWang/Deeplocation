...
def parse_args():
    ...
    parser.add_argument('-l', '--labels', type=str,
                        default='/dbfs/mnt/group03/dataset_1e_30.csv/part-00001-tid-314640504566531693-21a726bf-de01-4864-a5d1-ac2421146a7a-331729-1-c000.csv',
...
def writeoutput(args, num_predict, res_list, out_p):
    ...
    fname = f"dataset1_30_331729_inference_result.csv"
...
def main():
    ...
    emptyname = f"dataset1_30_331729_inference_empty.csv"
